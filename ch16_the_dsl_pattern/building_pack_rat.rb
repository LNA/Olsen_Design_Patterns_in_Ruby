# Now we must decide what interval, to and backup should do.

# They should remember that they were called.  To make this happen we need to set up
# data structures.  

# Olsen creates a class that represents the backup requests callec
# Backup.  It is a container for the information stored in the
# backup.pr file.  
...
# Next we need a class that represents the directories that are to be backed up:
